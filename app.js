...
var incompleteTaskHolder=document.querySelector(".tasklist_incompleted");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".tasklist_completed");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='task__label task__field';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="task__checkbox";
    editInput.type="text";
    editInput.className="task__field task__input";
...
var editTask=function(){
    ...
    editInput.classList.toggle("task__input_editable")
};
